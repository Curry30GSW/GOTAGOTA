    ...
    return (
        <>
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            Administra las sedes, usuarios y el conocimiento base de tu sede.
                        </p>
                    </div>
                    ...
                    <button
                        ...
                        className="inline-flex items-center justify-center gap-2 rounded-lg border border-brand-500 bg-brand-50 px-4 py-2.5 text-sm font-medium text-brand-700 transition hover:bg-brand-100 dark:border-brand-400 dark:bg-brand-900/20 dark:text-brand-300 dark:hover:bg-brand-900/40"
                    >
                ...
                <RagModal isOpen={isRagModalOpen} onClose={() => setIsRagModalOpen(false)} />
