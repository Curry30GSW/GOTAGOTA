...
interface VerCobradorModalProps {
    isOpen: boolean;
    onClose: () => void;
    selectedCobrador: Cobrador | null;
}

export default function VerCobradorModal({
    isOpen,
    onClose,
    selectedCobrador
}: VerCobradorModalProps) {
            ...
            <div className="relative">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-gray-900 dark:text-white">
                                Detalles del Cobrador
                            </h3>
                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                Información completa del cobrador
                            </p>
                        </div>
                    </div>
                    <button
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400">
                                <span className="flex items-center gap-1">
                                    <DocumentIcon />
                                    C.C. {selectedCobrador.cedula}
                                </span>
                                <span className="flex items-center gap-1">
                                    <IdIcon />
                                    ID: {selectedCobrador.id_cobrador}
                                </span>
                            </div>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-medium text-gray-900 dark:text-white">
                                            {selectedCobrador.direccion || 'No registrada'}
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="space-y-4">
                        <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-4">
                            <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-3 flex items-center gap-1">
                                <DocumentIcon /> Información Personal
                            </h4>
                            <div className="space-y-3">
                                <div className="flex items-center gap-3">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-medium text-gray-900 dark:text-white">
                                            {formatDate(selectedCobrador.created_at)}
                                        </p>
                                    </div>
                                </div>
                            </div>
